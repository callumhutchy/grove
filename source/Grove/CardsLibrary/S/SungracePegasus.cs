  ...
  public class SungracePegasus : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text(
          "{Flying}{I}(This creature can't be blocked except by creatures with flying or reach.){/I}{EOL}{Lifelink}{I}(Damage dealt by this creature also causes you to gain that much life.){/I}")
